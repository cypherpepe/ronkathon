...
## [0.1.0](https://github.com/cypherpepe/ronkathon/releases/tag/v0.1.0) - 2024-12-18
...
- sha256 (#86)
- feat/reed-solomon code ([#79](https://github.com/cypherpepe/ronkathon/pull/79))
- weil pairing (#80)
- ecdsa (#77)
- KZG commitment (#69)
- Tate pairing (#67)
...
- fix lint.yaml ([#134](https://github.com/cypherpepe/ronkathon/pull/134))
- lock
...
- Merge pull request [#2](https://github.com/cypherpepe/ronkathon/pull/2) from cypherpepe/fix/typos
...
- typo README.md
- typos README.md
- Add doc for Merkle Tree ([#165](https://github.com/cypherpepe/ronkathon/pull/165))
- release (#160)
- *(deps)* bump rstest from 0.22.0 to 0.23.0 (#162)
- remove udeps + exclude changelog from triggering release prs ([#161](https://github.com/cypherpepe/ronkathon/pull/161))
- release (#154)
- Add section on nonce reuse issue in modes of operation ([#159](https://github.com/cypherpepe/ronkathon/pull/159))
- Update README.md for modes of operation ([#158](https://github.com/cypherpepe/ronkathon/pull/158))
- Add AES-GCM(includes GHASH) ([#157](https://github.com/cypherpepe/ronkathon/pull/157))
- *(deps)* bump pretty_assertions from 1.4.0 to 1.4.1
- Consistency in Licenses / README across Repos ([#155](https://github.com/cypherpepe/ronkathon/pull/155))
- Update LICENSE-Apache ([#153](https://github.com/cypherpepe/ronkathon/pull/153))
- Update README.md ([#152](https://github.com/cypherpepe/ronkathon/pull/152))
- Update bounty.md
- Update bounty.md
- Update LICENSE-Apache
- Create LICENSE-Apache
- zkhack Bounty: Sumcheck ([#149](https://github.com/cypherpepe/ronkathon/pull/149))
- Adding the HMAC-SHA256 ([#147](https://github.com/cypherpepe/ronkathon/pull/147))
- Update Cargo.toml
- Update README.md
...
- release-plz workflow ([#107](https://github.com/cypherpepe/ronkathon/pull/107))
- Feat/dsl ([#60](https://github.com/cypherpepe/ronkathon/pull/60))
- Update README.md
- run tests in CI ([#105](https://github.com/cypherpepe/ronkathon/pull/105))
- fix doc attribute scope (#104)
- constant polynomial arithmetic ([#89](https://github.com/cypherpepe/ronkathon/pull/89))
- Update README.md
- Update README.md
- Update README.md
- Update README.md
- Update README.md
- docs ([#84](https://github.com/cypherpepe/ronkathon/pull/84))
- *(deps)* bump rstest from 0.19.0 to 0.21.0 (#85)
- Tiny rsa ([#68](https://github.com/cypherpepe/ronkathon/pull/68))
- ---
...
- readme (#46)
- Extension field ([#44](https://github.com/cypherpepe/ronkathon/pull/44))
- curves in sage ([#39](https://github.com/cypherpepe/ronkathon/pull/39))
- Bump anyhow from 1.0.82 to 1.0.83
- [wip] Add basic trusted setup and kzg ([#22](https://github.com/cypherpepe/ronkathon/pull/22))
- montgomery arithmetic ([#23](https://github.com/cypherpepe/ronkathon/pull/23))
- Colin/polynomials ([#19](https://github.com/cypherpepe/ronkathon/pull/19))
- curve implementation updated ([#21](https://github.com/cypherpepe/ronkathon/pull/21))
- lint
